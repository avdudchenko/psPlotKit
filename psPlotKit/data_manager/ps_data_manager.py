...
class psDataManager(dict):
    ...
    def get_costing(self, costing_groups, kwargs={}):
        for instance in self.psDataImportInstances:
            pscosting = psCosting(instance, **kwargs)
    ...
    def generate_data_stack(
        ...
        # assert False
        if unique_dirs != {}:
            _logger.debug("Stacking: {}".format(dir_to_stack))
            _logger.debug("Stack indexes are: {}".format(stack_idxs))
            _logger.debug("Unique stacks are: {}".format(unique_dirs))
            new_dirs = []
            new_keys = []
            ...
            for uq, items in unique_dirs.items():
                ...
                stack_idxs, idxs = sort_idxs(idxs)
                temp_map_data = []
                map_units = []
                temp_map_idxs = []
                ...
                if (
                    ...
                    global_stack_idxs, global_idxs = sort_idxs(
